...
with the woodcoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a woodcoind.  `P2PInterface`
...
Test objects for interacting with a woodcoind node over the p2p interface.
