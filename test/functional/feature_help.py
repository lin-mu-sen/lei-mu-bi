...
"""Verify that starting woodcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start woodcoin with -h for help text")
        ...
        self.log.info("Start woodcoin with -version for version information")
        ...
        self.log.info("Start woodcoind with -fakearg to make sure it does not start")
