...
router", implementing the woodcoin wire protocol and relay, making
...
during the *configure* step of building woodcoind:
...
For instance:
    ...
    $ woodcoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/woodcoind.tx.raw \
...
These options can also be provided in woodcoin.conf.
...
From the perspective of woodcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into woodcoind directly. Furthermore, no information is
