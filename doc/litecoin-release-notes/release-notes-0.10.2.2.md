Litecoin Core version 0.10.2.2 is now available from:
  ...
  <https://download.woodcoin.org/woodcoin-0.10.2.2/>
...
woodcoind/woodcoin-qt (on Linux).
...
- woodcoind no longer sends RPC commands.  You must use the separate woodcoin-cli command line utility.
