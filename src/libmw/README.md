...
### crypto/
Crypto libraries not provided by woodcoin or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by woodcoin, I was uncomfortable with its API and its handling of unicode conversions.
