...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " woodcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  woodcoin-tx [options] <hex-tx> [commands]  Update hex-encoded woodcoin transaction\n" +
            "or:     woodcoin-tx [options] -create [commands]   Create hex-encoded woodcoin transaction\n" +
            "\n";
