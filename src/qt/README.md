...
Used to process BIP21 payment URI requests. Also handles URI based application switching (e.g. when following a woodcoin:... link from a browser).
...
10. Start debugging with Qt Creator (you might need to the executable to "woodcoin-qt" under "Run", which is where you can also add command line arguments)
