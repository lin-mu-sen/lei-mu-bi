...
public:
    CMainParams() {
        ...
        // making this blocking height effectively inifinte for woodcoin
        consensus.BIP65Height = 999918684; // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        ...
        consensus.nPowTargetTimespan = 1.0 * 60 * 60; // 1 hr
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartHeight = 1000000;  // 2161152; // 2161152 End November 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 1000000;  // 2370816; // 364 days later

        // Deployment of MWEB (LIP-0002, LIP-0003, and LIP-0004)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 1000000; // 2217600; // End Feb 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 1000000; // 2427264; // 364 days later
...
// unsigned char pchMessageStart[4] = { 0xfc, 0xd9, 0xb7, 0xdd };
        ...
        vSeeds.emplace_back("dnsseed.logbin.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.woodcointools.com");
        vSeeds.emplace_back("seed-b.woodcoin.loshan.co.uk");
